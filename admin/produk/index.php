    ...
    <main class="admin-main">
        <div class="page-head">
            <div>
                ...
                <p class="text-muted mb-0">Tambah, ubah, dan hapus daftar produk.</p>
            </div>
        </div>
        <?php if ($flash): ?>
        ...
        <div class="alert alert-danger">
            <ul><?php foreach ($errors as $error): ?><li><?= safe($error) ?></li><?php endforeach; ?></ul>
        </div>
        <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:80px">
                                ...
                                <img src="/Kasir/assets/images/<?= safe($item['image']) ?>" alt=""
                                    style="max-width:70px; height:auto; border-radius:6px;">
                                <?php else: ?>
                                -
                                <?php endif; ?>
                            </td>
                            ...
                            <td><?= $item['stok'] ?></td>
                            <td>
                                <a href="/Kasir/admin/produk/edit.php?id=<?= $item['id'] ?>" class="btn btn-sm btn-outline-secondary">Edit</a>
                                <a href="/Kasir/admin/produk/index.php?delete=<?= $item['id'] ?>"
                                    onclick="return confirm('Hapus produk ini?')" class="btn btn-sm btn-danger">Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
